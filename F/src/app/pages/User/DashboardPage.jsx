...
export function DashboardPage() {
  ...
  return (
    <div
      className="flex-grow flex flex-col bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage:
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex-grow flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-6">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="bg-white/10 backdrop-blur-md overflow-auto rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="max-h-30 overflow-y-auto pr-2">
        ...
        {/* <div className="w-full h-155 md:w-2/3 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative min-h-[400px]">
          <img
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-1">
                  All rides are tracked and drivers are verified for your
                  security.
                </p>
              </div>
            </div>
          ...
          {pickupLocation && dropLocation && (
            <div className="absolute bottom-4 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:w-96 bg-black text-white rounded-xl p-4 shadow-2xl flex items-center justify-between">
              ...
              <button
                onClick={handleFindCabs}
                className="text-sm font-bold text-blue-400 hover:text-blue-300 whitespace-nowrap"
              >
                Go →
              </button>
            </div>
