...
import { MapPin, Clock, CreditCard, ShieldCheck, Smartphone, Navigation } from 'lucide-react';
...
export function LandingPage() {
  const features = [
    {
      title: 'Quick Booking',
      description: 'Book a ride in seconds. Enter your destination and get an estimate instantly.',
      icon: <Clock className="w-6 h-6 text-blue-500" />
    },
    {
      title: 'Safe & Secure',
      description: 'All our drivers are background checked and vehicles are regularly inspected.',
      icon: <ShieldCheck className="w-6 h-6 text-blue-500" />
    },
    {
      title: 'Cashless Payments',
      description: 'Pay securely with your preferred method - credit card, wallet, or net banking.',
      icon: <CreditCard className="w-6 h-6 text-blue-500" />
    },
    {
      title: 'Real-time Tracking',
      description: 'Track your cab in real-time on the map as it approaches your pickup location.',
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-black text-white h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-xl">
            ...
            >
              Request a ride, hop in, and go. UCab is the smartest way to get around the city.
            </motion.p>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why choose UCab?</h2>
            <p className="text-lg text-gray-600">
              We're more than just an app. We're your daily travel companion, dedicated to providing the best riding experience in the city.
            </p>
          </div>
      ...
      <section className="bg-blue-600 py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to roll?</h2>
          <p className="text-xl text-blue-100 mb-10">Sign up in seconds and get moving.</p>
          <Link
            to="/register"
