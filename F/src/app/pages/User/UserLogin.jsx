    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-zinc-50 py-12 px-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-500 mt-2 text-center">Enter your details to access your account</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); window.location.href = '/dashboard'; }}>
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input type="email" placeholder="you@example.com" className="pl-10 h-12" required />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link to="#" className="text-sm text-blue-600 hover:underline font-medium">Forgot Password?</Link>
            </div>
            <div className="relative">
              <div className="absolute top-1/2 left-3 -translate-y-1/2 text-zinc-400">
                <Lock size={18} />
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="flex-shrink-0 mx-4 text-zinc-400 text-sm">Or continue with</span>
            <div className="flex-grow border-t border-zinc-200"></div>
          </div>

          <Button type="button" variant="outline" className="w-full h-12 text-base font-medium text-zinc-700 bg-white">
